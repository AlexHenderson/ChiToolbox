...
%C 2002 Amos Storkey
%
%Mlint code optimisation in 2007 by Kris De Gussem, Raman Spectroscopy
%Research Group, Department of analytical chemistry, Ghent University
%
...
if (fid<0)
  ...
  dflag = zeros(length(endpos),(length(delimpos)/length(endpos))+1);
