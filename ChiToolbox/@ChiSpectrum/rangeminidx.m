...
%   and toidx are index values (not in xaxis units). themin and idx are
%   scalars of the minimum intensity and its index position respectively.
%
% Copyright (c) 2019, Alex Henderson.
% Licenced under the GNU General Public License (GPL) version 3.
%
% See also 
%   rangemin rangesum rangemedian rangemean measurearea measureareaidx ChiSpectrum.
