...
%
% Description
%   themean = rangemean(from,to) calculates the mean of the spectrum
%   between from and to inclusive. The parameters from and to are in xaxis
%   units. themean is the scalar mean intensity.
%
% Copyright (c) 2019, Alex Henderson.
% Licenced under the GNU General Public License (GPL) version 3.
%
% See also 
%   rangemeanidx rangesum rangemedian measurearea measureareaidx ChiSpectrum.
