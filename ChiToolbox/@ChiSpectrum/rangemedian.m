...
%
% Description
%   themedian = rangemedian(from,to) calculates the median of the spectrum
%   between from and to inclusive. The parameters from and to are in xaxis
%   units. themedian is the scalar median intensity.
%
% Copyright (c) 2019, Alex Henderson.
% Licenced under the GNU General Public License (GPL) version 3.
%
% See also 
%   rangemedianidx rangesum rangemean measurearea measureareaidx ChiSpectrum.
