...
function test_removerangeidx(obj)
obj = obj.removerangeidx(3,6);
assertEqual(obj.channels(), 12);

function test_removerange(obj)
obj = obj.removerange(3,6);
assertEqual(obj.channels(), 12);
...
spec = obj.totalspectrum();
expected.log = spec.log;
assertEqual(spec, expected);
...
expected_totalspectrum.log = obj.log;
...
assertEqual(obj.sumrangeidx.m(7,9), expected);

function test_sumrangeidx2(obj) % single x index
...
assertEqual(obj.sumrangeidx(9), expected);
