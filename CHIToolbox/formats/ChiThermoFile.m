function thermoData = ChiThermoFile(filenames)

% ChiThermoFile File format handler for Thermo Scientific GRAMS (.spc) files
%
% Syntax
%   thermoData = ChiThermoFile();
%   thermoData = ChiThermoFile(filenames);
%
% Description
%   thermoData = ChiThermoFile() prompts the user for one, or more, Thermo
%   Scientific GRAMS (*.spc) files.
% 
%   thermoData = ChiThermoFile(filenames) opens the filenames provided in a
